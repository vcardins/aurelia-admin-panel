	...
	configure(){		
		...
		let appRouterConfig:any = function(config:RouterConfiguration){
			...
			config.map([
				...
				{ route: 'contacts',  	   name: 'contacts', 	 moduleId: './contacts/contacts', 	      nav: true, title:'Contacts', auth:true, icon:'user', description:'' },				
				...
				{ route: 'profile',        name: 'profile', 	 moduleId: './account/profile',           nav: true, title:'Profile', icon:'', description:'' }
    		]);
